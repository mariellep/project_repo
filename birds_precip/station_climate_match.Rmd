...
Let's look at just the times when the temperature difference exceeds 10 degrees. (Precipitation isn't shown here because we only had data from one of the stations)
```{r plot_only_diffs}
